...
* June 22 (Day 0)
  ...
  * I’d love for the search page to offer some kind of suggestions so that I can think of lenses I might considering saving…

### Background

As of mid-July (2025), I've been using the 6 default lenses we seeded the app with:&#x20;

1. **all pings**
2. **re-pings**&#x20;
3. **period of day** (nights, evenings, afternoons, mornings)
4. &#x20;**day of week**
5. **last week**
6. **hidden**

In this time, a few things have surfaced:

1. I (and other Practitioners) noticed themselves wanting to see "all pings" immediately rather than "re-pings" as we initially configured to show first upon navigating to browse from capture
2. Practitioners have expressed curiosity/uncertainty about when/why to revisit Pings
3. .
